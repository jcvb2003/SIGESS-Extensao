...
export function resolvePortalBridge(hostname: string): string | null {
  ...
  if (hostname.includes(CAEPF_HOST) || hostname.includes(ESOCIAL_HOST)) return "assets/caepf_bridge.js";
